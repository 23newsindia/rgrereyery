        ...
        if (
            ...
            if (_product_type === 'woosb' && typeof $(_this).attr('data-href') !== 'undefined') {
                ...
                if (!sidebar_holder) {
                    ...
                    var _html_mask_load = '<div class="ns-mask-load">' + _close + '<div class="product-quickview-img" style="height: '+ _img_load_height + 'px;"></div>' +
                    ...
                    if ($(_nasa_quickview_popup).length < 1) {
                        ...
                        $(_nasa_quickview_popup).find('.row').prepend(_close);
