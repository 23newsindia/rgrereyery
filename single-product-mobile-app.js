        ...
        setTimeout(function() {
            if ($(_nasa_product_details_page).length && $('body').hasClass('nasa-mobile-app')) {
                ...
                if ($(_focus_info).length) {
                    var _title = $('body').find('input[name="nasa-title-bc-general"]').val();
                    var _target = '.focus-info';
                ...
                $(_ns_tab_item).each(function() {
                    ...
                    var _title =$(_nasa_content).find('.nasa-title').text().trim();
                    var _id= $(_nasa_content).attr('id');
    
                    if (_id == 'nasa-scroll-reviews') {
                        var _title = $('body').find('input[name="nasa-title-bc-review"]').val();
                    }
                ...
                if ($(_related_product).length) {
                    var _title = $('body').find('input[name="nasa-title-bc-recommendation"]').val();
                    var _target = '.related-product:first';
